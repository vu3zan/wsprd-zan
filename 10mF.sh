...
# This script is for ## 10m, located in ~/wsprd, and named 10mF.sh
...
~/rtlsdr-wsprd/rtlsdr_wsprd -f 10m -c   A1XYZ -l   AB12cd -g 29 &>> ~/wsprd/wlogs/wsprd.log &
    elif [ "$bandparam" -eq 2 ]; then 
~/rtlsdr-wsprd/rtlsdr_wsprd -f 28.1246M -c   A1XYZ -l   AB12cd -g 29 &>> ~/wsprd/wlogs/wsprd.log &
    else  
~/rtlsdr-wsprd/rtlsdr_wsprd -f 28.124600M -c   A1XYZ -l   AB12cd -g 29 &>> ~/wsprd/wlogs/wsprd.log &
    fi
