...
~/rtlsdr-wsprd/rtlsdr_wsprd -f 80m -c   A1XYZ -l   AB12cd -g 29 &>> ~/wsprd/wlogs/wsprd.log &
    elif [ "$bandparam" -eq 2 ]; then
~/rtlsdr-wsprd/rtlsdr_wsprd -f 3.5686M -c   A1XYZ -l   AB12cd -g 29 &>> ~/wsprd/wlogs/wsprd.log &
    else
 ~/rtlsdr-wsprd/rtlsdr_wsprd -f 3.568600M -c   A1XYZ -l   AB12cd -g 29 &>> ~/wsprd/wlogs/wsprd.log &
    fi
    
# OLD WSPR frequency for 80m band is below
    # this_parameter="OLD 3.5926M" 
# ~/rtlsdr-wsprd/rtlsdr_wsprd -f 3.5926M -c A1XYZ -l AB12cd -g 29 &>> ~/wsprd/wlogs/wsprd.log &
    # this_parameter="OLD 3.592600M" 
# ~/rtlsdr-wsprd/rtlsdr_wsprd -f 3.592600M -c A1XYZ -l AB12cd -g 29 &>> ~/wsprd/wlogs/wsprd.log &
